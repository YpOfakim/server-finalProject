...
// await conDB.promise().query(insertDaily_segments);
    ...
    const insertNotes = `
    INSERT INTO notes  (user_id, body, note_date, note_title) VALUES
    (1, "התפילה מנתבת את דרכה לקדוש ברוך הוא כמו ששופכים מים על מדרכה עם אבנים משתלבות.
    ברגע ששופכים אותם הם הולכים ומתפצלים לכל הכיוונים, וגם אם אני לא מקבלת את מה שביקשתי , התפילה הולכת לדברים אחרים שצריך בחיים.
    תחשבי על אדם שמבקש ומתפלל על זיווג ומרגיש שהוא לא נענה... בינתיים התפילות שלו הולכות על ילדים, פרנסה וכו', כי צריך עוד דברים בחיים חוץ מזיווג והוא יקבל את האחת שלו כשיגיע הזמן.",
    '2025-05-29',"התפילה היא כמו מים"),
    (1, "התפילה מנתבת את דרכה לקדוש ברוך הוא כמו ששופכים מים על מדרכה עם אבנים משתלבות.
    ברגע ששופכים אותם הם הולכים ומתפצלים לכל הכיוונים, וגם אם אני לא מקבלת את מה שביקשתי , התפילה הולכת לדברים אחרים שצריך בחיים.
    תחשבי על אדם שמבקש ומתפלל על זיווג ומרגיש שהוא לא נענה... בינתיים התפילות שלו הולכות על ילדים, פרנסה וכו', כי צריך עוד דברים בחיים חוץ מזיווג והוא יקבל את האחת שלו כשיגיע הזמן.",
    '2025-06-01',"התפילה היא כמו מים"),
    (1, "התפילה מנתבת את דרכה לקדוש ברוך הוא כמו ששופכים מים על מדרכה עם אבנים משתלבות.
    ברגע ששופכים אותם הם הולכים ומתפצלים לכל הכיוונים, וגם אם אני לא מקבלת את מה שביקשתי , התפילה הולכת לדברים אחרים שצריך בחיים.
    תחשבי על אדם שמבקש ומתפלל על זיווג ומרגיש שהוא לא נענה... בינתיים התפילות שלו הולכות על ילדים, פרנסה וכו', כי צריך עוד דברים בחיים חוץ מזיווג והוא יקבל את האחת שלו כשיגיע הזמן.",
    '2025-06-15',"התפילה היא כמו מים"),
    (1, "התפילה מנתבת את דרכה לקדוש ברוך הוא כמו ששופכים מים על מדרכה עם אבנים משתלבות.
    ברגע ששופכים אותם הם הולכים ומתפצלים לכל הכיוונים, וגם אם אני לא מקבלת את מה שביקשתי , התפילה הולכת לדברים אחרים שצריך בחיים.
    תחשבי על אדם שמבקש ומתפלל על זיווג ומרגיש שהוא לא נענה... בינתיים התפילות שלו הולכות על ילדים, פרנסה וכו', כי צריך עוד דברים בחיים חוץ מזיווג והוא יקבל את האחת שלו כשיגיע הזמן.",
    '2025-06-17',"התפילה היא כמו מים"),
    (1, "התפילה מנתבת את דרכה לקדוש ברוך הוא כמו ששופכים מים על מדרכה עם אבנים משתלבות.
    ברגע ששופכים אותם הם הולכים ומתפצלים לכל הכיוונים, וגם אם אני לא מקבלת את מה שביקשתי , התפילה הולכת לדברים אחרים שצריך בחיים.
    תחשבי על אדם שמבקש ומתפלל על זיווג
     ומרגיש שהוא לא נענה... בינתיים התפילות שלו הולכות על ילדים, פרנסה וכו', כי צריך עוד דברים בחיים חוץ מזיווג והוא יקבל את האחת שלו כשיגיע הזמן.",
    '2025-06-23',"התפילה היא כמו מים")
     `;
